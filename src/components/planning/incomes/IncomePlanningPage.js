...
import PlanningNav from "./IncomePlanningNav/PlanningNav";
import PlanningListSpace from "./PlanningListSpace";

const IncomePlanningPage = () => {
  ...
  const { get, post, put, response } = useFetch(
    `https://webhomebudget.azurewebsites.net/api/plan/incomes`,
    {
      headers: {
...
export default IncomePlanningPage;
